...
use super::composite_private_key::CompositePrivateKey;
use super::composite_public_key::CompositePublicKey;
...
pub struct CertificateBuilder {
    ...
    profile: Profile,
    signer: DsaManager,
    signer_pk: CompositePublicKey,
    signer_sk: CompositePrivateKey,
}
...
impl CertificateBuilder {
    ...
    pub fn new(
        ...
        validity: Validity,
        subject: Name,
        subject_public_key_info: CompositePublicKey,
        signer: DsaManager,
        signer_pk: CompositePublicKey,
        signer_sk: CompositePrivateKey,
    ) -> Result<Self> {
    ...
    pub fn build(&mut self) -> Result<Certificate> {
        ...
        let signature = self.signer.sign(&self.signer_sk.to_der()?, &tbs_der)?;
