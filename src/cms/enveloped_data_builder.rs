...
impl<'a> EnvelopedDataBuilder<'a> {
    pub fn new(cae_type: CeaType) -> Result<Self> {
    ...
    pub fn attribute(&mut self, attribute: Attribute) -> Result<&mut Self> {
...
mod tests {
    ...
    fn test_enveloped_data_kemri() {
        ...
        let mut builder =
            EnvelopedDataBuilder::new(cae_type).expect("Failed to create EnvelopedDataBuilder");
