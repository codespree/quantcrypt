...
impl HashTypeConfig for PrehashDsaType {
    ...
    fn get_hash_type(&self) -> Option<HashType> {
        match self {
            ...
            // Composite ML-DSA Signature Algorithms (draft-19).
            // Every composite is pre-hashed; the PH per algorithm is fixed by the OID.
            PrehashDsaType::MlDsa44Rsa2048Pss => Some(HashType::Sha256),
            PrehashDsaType::MlDsa44Rsa2048Pkcs15 => Some(HashType::Sha256),
            PrehashDsaType::MlDsa44Ed25519 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa44EcdsaP256 => Some(HashType::Sha256),
            PrehashDsaType::MlDsa65Rsa3072Pss => Some(HashType::Sha512),
            PrehashDsaType::MlDsa65Rsa3072Pkcs15 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa65Rsa4096Pss => Some(HashType::Sha512),
            PrehashDsaType::MlDsa65Rsa4096Pkcs15 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa65EcdsaP256 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa65EcdsaP384 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa65EcdsaBrainpoolP256r1 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa65Ed25519 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa87EcdsaP384 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa87EcdsaBrainpoolP384r1 => Some(HashType::Sha512),
            PrehashDsaType::MlDsa87Ed448 => Some(HashType::Shake256_64),
            PrehashDsaType::MlDsa87Rsa3072Pss => Some(HashType::Sha512),
            PrehashDsaType::MlDsa87Rsa4096Pss => Some(HashType::Sha512),
            PrehashDsaType::MlDsa87EcdsaP521 => Some(HashType::Sha512),
